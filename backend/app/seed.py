...
def init_db():
    ...
    CREATE TABLE IF NOT EXISTS balloon_rules(id INTEGER PRIMARY KEY, balloon_period INTEGER, balloon_cap REAL, enabled INTEGER, created_at TEXT, updated_at TEXT);
    """)
